...
@Service
public class AdminPanelReverseGeocodingService {

    private static final String BASE_URL = "https://nominatim.openstreetmap.org";
    private static final String USER_AGENT = "fitnest-catalog-backend";
    private final RestTemplate restTemplate = new RestTemplate();

    public AdminPanelGeocodingResponse reverseGeocode(Double latitude, Double longitude) {
        ...
        try {
            ...
            if (body != null) {
                ...
                if (addressObj instanceof Map) {
                    ...
                    if (district == null) district = address.get("suburb");
                    if (district == null) district = address.get("quarter");
                }
                return AdminPanelGeocodingResponse.builder()
