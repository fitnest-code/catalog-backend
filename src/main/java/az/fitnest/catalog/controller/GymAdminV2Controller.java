...
@Tag(name = "Gym Admin V2", description = "İdman zallarını idarə etmək üçün V2 administrativ ucluqlar")
...
public class GymAdminV2Controller {
    ...
    @PreAuthorize("hasRole('ADMIN')")
    @PostMapping("/step1")
    public ResponseEntity<GymCreateStep1Response> createGymStep1(@Valid @RequestBody GymCreateStep1RequestV2 request) {
    ...
    public ResponseEntity<Void> validateStep1(@Valid @RequestBody GymCreateStep1RequestV2 request) {
    ...
    public ResponseEntity<GymSubscriptionsAdminResponseV2> getGymSubscriptions(@PathVariable("id") Long gymId) {
    ...
    public ResponseEntity<Void> updateGymSubscriptions(@PathVariable Long id, @Valid @RequestBody GymCreateStep6RequestV2 request) {
    ...
    public ResponseEntity<GymInfoAdminResponseV2> getGymDetails(@PathVariable("id") Long gymId) {
    ...
    public ResponseEntity<Void> updateGymDetails(@PathVariable("id") Long gymId, @Valid @RequestBody GymInfoUpdateRequestV2 request) {
