...
public class GymNearbyResponseDto {
    ...
    public GymNearbyResponseDto(Long gymId, String name, String address, Double rating, Boolean isNew, Double distanceKm) {
        this.gymId = gymId;
        this.name = name;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GymNearbyResponseDto)) {
            return false;
        }
        GymNearbyResponseDto other = (GymNearbyResponseDto) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof GymNearbyResponseDto;
    }
    ...
    public String toString() {
        return "GymNearbyResponseDto(gymId=" + this.getGymId() + ", name=" + this.getName() + ", address=" + this.getAddress() + ", rating=" + this.getRating() + ", isNew=" + this.getIsNew() + ", distanceKm=" + this.getDistanceKm() + ")";
    }
    ...
    public static class GymNearbyResponseDtoBuilder {
        ...
        public GymNearbyResponseDto build() {
            return new GymNearbyResponseDto(this.gymId, this.name, this.address, this.rating, this.isNew, this.distanceKm);
        }

        public String toString() {
            return "GymNearbyResponseDto.GymNearbyResponseDtoBuilder(gymId=" + this.gymId + ", name=" + this.name + ", address=" + this.address + ", rating=" + this.rating + ", isNew=" + this.isNew + ", distanceKm=" + this.distanceKm + ")";
        }
    }
}
