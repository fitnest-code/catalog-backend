...
public class StoreWorkHourDto {
    ...
    public StoreWorkHourDto() {
    }

    public StoreWorkHourDto(DayOfWeek day, LocalTime from, LocalTime to) {
        this.day = day;
        this.from = from;
        this.to = to;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof StoreWorkHourDto)) {
            return false;
        }
        StoreWorkHourDto other = (StoreWorkHourDto) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof StoreWorkHourDto;
    }
    ...
    public String toString() {
        return "StoreWorkHourDto(day=" + this.getDay() + ", from=" + this.getFrom() + ", to=" + this.getTo() + ")";
    }
}
